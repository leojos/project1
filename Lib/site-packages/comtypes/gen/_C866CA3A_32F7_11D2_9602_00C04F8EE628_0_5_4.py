...
__all__ = [
    'SVP_3', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SASetState', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechPhraseRule', 'SpeechRecoEvents',
    'DISPID_SMSGetData', 'DISPID_SpeechRecoContext',
    'SPEI_SR_RETAINEDAUDIO', 'SDKLLocalMachine', 'DISPID_SVEPhoneme',
    'SPSInterjection', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechPhraseRules', 'SpeechMicTraining',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVEventInterests',
    'DISPID_SPPs_NewEnum', 'SPDKL_CurrentUser', 'DISPID_SPRulesItem',
    'SITooSlow', 'SP_VISEME_9',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SINoise',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLGetPronunciations', 'DISPID_SPEActualConfidence',
    'eLEXTYPE_PRIVATE10', 'STCInprocHandler',
    'DISPID_SVSRunningState', 'SpeechTokenShellFolder',
    'DISPID_SPPsCount', 'DISPID_SpeechRecognizer',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSSuppressWord', 'SPVPRI_OVER',
    'ISpObjectTokenCategory', 'SREPhraseStart', 'SPPS_RESERVED3',
    'SPPHRASEREPLACEMENT', 'SDTPronunciation', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechPhraseProperties', 'DISPID_SGRSTNextState', 'SVP_1',
    'DISPID_SRAudioInputStream', 'ISpeechRecoResultTimes',
    'SPRULESTATE', 'SpObjectToken', 'SpeechInterference',
    'SPEI_PHONEME', 'SpeechTokenKeyUI', 'SPVPRIORITY',
    ...
    'SAFTNoAssignedFormat', 'SVP_6', 'DISPID_SpeechMemoryStream',
    'SPEI_VISEME', 'DISPID_SOTGetDescription', 'STSF_FlagCreate',
    'ISpEventSource', 'SpeechGrammarTagUnlimitedDictation',
    'SP_VISEME_18', 'SPPS_Unknown', 'DISPID_SVSpeakStream',
    'DISPID_SGRsFindRule', 'SPFM_CREATE', 'SDKLDefaultLocation',
    'DISPID_SFSClose', 'DISPID_SOTRemove', 'DISPID_SPIRule',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SLPSymbolic',
    'DISPID_SRProfile', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpProperties', 'DISPID_SpeechAudio',
    'DISPID_SREmulateRecognition', 'SPEI_SOUND_START', 'SPBO_NONE',
    'SGLexical', 'SP_VISEME_12', 'ISpPhoneConverter',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpSharedRecognizer',
    'DISPID_SWFEBitsPerSample', 'SBONone', 'DISPID_SpeechBaseStream',
    'SPSUnknown', 'SPPS_Noncontent', 'SPGRAMMARWORDTYPE',
    ...
    'SDTRule', 'SP_VISEME_13', 'SPEI_SR_PRIVATE', 'SPAS_PAUSE',
    'SWTDeleted', 'DISPID_SAFType', 'SAFT8kHz16BitStereo', 'SLTApp',
    'LONG_PTR', 'DISPID_SGRsDynamic', 'SPEVENTENUM',
    'SAFT16kHz8BitStereo', 'SAFT22kHz16BitStereo',
    'SpeechAudioVolume', 'DISPID_SMSAMMHandle',
    'SPWORDPRONUNCIATIONLIST', 'SVP_20', 'SpNullPhoneConverter',
    'DISPID_SPAPhraseInfo', 'eWORDTYPE_ADDED', 'SVP_14',
    'DISPID_SPPChildren', 'DISPID_SPIElements',
    'ISpeechPhraseProperties', 'DISPID_SPIProperties',
    'ISpPhoneticAlphabetSelection',
    'ISpeechGrammarRuleStateTransitions', 'SVP_19',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SFSOpen', 'STSF_LocalAppData',
    'ISpEventSink', 'SRERecognition', 'SAFT32kHz16BitMono',
    'SPPHRASE', 'SpeechLoadOption', 'DISPID_SDKGetBinaryValue',
    'SDA_One_Trailing_Space', 'SPSMF_SAPI_PROPERTIES',
    'eLEXTYPE_RESERVED7', 'SECFEmulateResult',
    'DISPID_SVEVoiceChange', 'SWPKnownWordPronounceable', 'IStream',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRRTimes',
    'DISPID_SVEStreamStart', 'SFTSREngine', 'SPCONTEXTSTATE',
    ...
    'DISPID_SRCEHypothesis', 'DISPID_SGRClear', 'IEnumString',
    'SP_VISEME_0', 'DISPID_SPERetainedStreamOffset', 'SRSEIsSpeaking',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRCEEndStream',
    'SVSFVoiceMask', 'ISpSerializeState', 'SAFT12kHz16BitStereo',
    'SPWT_DISPLAY', 'SGSDisabled', 'SPAR_High', 'DISPID_SBSSeek',
    'DISPID_SABufferNotifySize', 'DISPID_SPEAudioSizeTime',
    'DISPID_SASState', 'DISPID_SLWsCount', 'DISPID_SGRSTText',
    'DISPID_SVStatus', 'SVEPrivate', 'SAFT22kHz8BitStereo',
    ...
    'SRCS_Enabled', 'DISPID_SVGetVoices', 'DISPID_SVGetProfiles',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE4',
    'ISpRecognizer3', 'eLEXTYPE_APP', 'DISPID_SPEAudioStreamOffset',
    'SpeechVoicePriority', 'SPXMLRESULTOPTIONS', 'ISpeechObjectToken',
    'SpeechRuleAttributes', 'SPFM_OPEN_READWRITE',
    'SREPropertyStringChange', 'DISPID_SDKCreateKey',
    'DISPID_SpeechGrammarRules', 'ISpNotifyTranslator',
    ...
    'DISPID_SPEAudioSizeBytes', 'SREInterference', 'SGRSTTEpsilon',
    'SREPrivate', 'SpAudioFormat', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechFileStream', 'DISPID_SRSCurrentStreamPosition',
    'SP_VISEME_19', 'SPWT_PRONUNCIATION', 'DISPID_SGRsCommitAndSave',
    ...
    'ISpeechPhraseElements', 'SRATopLevel', 'SAFT22kHz16BitMono',
    'SpeechTokenContext', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPCATEGORYTYPE', 'SVEStartInputStream', 'SDKLCurrentConfig',
    'SECHighConfidence', 'ISpStreamFormatConverter', 'ISpObjectToken',
    'SpeechRuleState', 'ISpeechWaveFormatEx', 'SPRST_ACTIVE_ALWAYS',
    'SPPS_Function', 'DISPID_SVDisplayUI', 'SPSHT_OTHER',
    'DISPID_SRStatus', 'SPEI_INTERFERENCE', 'DISPID_SLPsCount',
    'DISPID_SADefaultFormat', 'ISpeechPhraseElement',
    'DISPID_SGRsCommit', 'DISPID_SMSADeviceId',
    'DISPID_SPIAudioSizeTime', 'SPEI_MAX_TTS',
    'DISPID_SRGCmdLoadFromObject', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE18', 'SRCS_Disabled',
    'SGRSTTRule', 'DISPID_SRGId', 'SVSFPurgeBeforeSpeak',
    'DISPID_SOTCreateInstance', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechMemoryStream', 'SAFTADPCM_11kHzMono',
    'DISPID_SRSCurrentStreamNumber', 'SAFT24kHz8BitMono',
    'SITooQuiet', 'SpResourceManager', 'SPPS_LMA',
    'DISPID_SVEBookmark', 'SVP_2', 'ISpeechRecoResult',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTRule',
    'SpeechCategoryAppLexicons', 'DISPID_SOTCGetDataKey',
    'eLEXTYPE_PRIVATE6', 'SVP_13', 'SPEVENT', 'SRTAutopause',
    'DISPID_SRCEAudioLevel', 'SPAS_STOP', 'SPCT_SUB_COMMAND',
    'DISPID_SPPName', 'SECFDefault', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRGRecoContext', 'ISpeechLexiconWord', 'SPRST_INACTIVE',
    ...
    'DISPID_SPRuleConfidence', 'SVP_0', 'eLEXTYPE_RESERVED10',
    'SPPHRASERULE', 'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE16',
    'DISPID_SVSLastResult', 'DISPID_SRRTLength', 'SAFT48kHz16BitMono',
    'DISPID_SpeechLexiconWord', 'DISPID_SRGDictationSetState',
    'SAFT11kHz16BitMono', 'STSF_AppData', 'SASStop', 'SPVOICESTATUS',
    'SP_VISEME_3', 'DISPIDSPTSI_SelectionLength',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPARecoResult', 'ISpeechLexiconPronunciations',
    'ISpVoice', 'SLOStatic', 'DISPID_SDKDeleteValue', 'SPWORD',
    'Speech_Max_Pron_Length', 'DISPID_SPEsCount',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRSTsItem',
    'SP_VISEME_5', 'SPCT_COMMAND', 'SLTUser', 'SRTReSent',
    'DISPID_SRRSpeakAudio', 'DISPID_SRRSetTextFeedback',
    'SpeechBookmarkOptions', 'DISPID_SpeechLexiconProns',
    'ISpeechGrammarRules', 'SPINTERFERENCE_TOOLOUD',
    'ISequentialStream', 'SVSFIsXML', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPIReplacements',
    'SpeechTokenKeyAttributes', 'DISPID_SPAStartElementInResult',
    'DISPID_SRSetPropertyString', 'SPEI_FALSE_RECOGNITION',
    'SpeechGrammarTagWildcard', 'SPBO_PAUSE', 'SpeechRunState',
    'Speech_Max_Word_Length', 'DISPID_SRRGetXMLErrorInfo',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_PRIVATE13',
    'SpeechCategoryRecoProfiles', 'SGRSTTTextBuffer',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechRecoContextEvents',
    'SpeechDataKeyLocation', 'SpVoice', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCRecognizer', 'DISPID_SVAudioOutput',
    'DISPID_SGRSTs_NewEnum', 'SPEI_MIN_SR', 'SRERecoOtherContext',
    ...
    'DISPID_SPPNumberOfElements', 'SpeechPartOfSpeech', 'SAFTText',
    'SPBINARYGRAMMAR', 'DISPIDSPTSI', 'SpeechWordPronounceable',
    'DISPID_SOTSetId', 'DISPID_SRRGetXMLResult',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_PRIVATE20',
    'SpeechVoiceEvents', 'SpeechDictationTopicSpelling',
    'DISPID_SRCCmdMaxAlternates', 'ISpResourceManager', 'ISpShortcut',
    'SAFTCCITT_ALaw_11kHzMono', 'SpUnCompressedLexicon',
    'SpSharedRecoContext', 'SRADynamic', 'eLEXTYPE_MORPHOLOGY',
    'SRAInterpreter', 'SVP_21', 'SAFT24kHz16BitStereo',
    'DISPID_SLWPronunciations', 'DISPID_SRCreateRecoContext',
    'SVSFlagsAsync', 'SpCompressedLexicon', 'SPPS_SuppressWord',
    'DISPID_SVVolume', 'DISPID_SAStatus', 'ISpeechAudioStatus',
    ...
    'DISPID_SVIsUISupported', 'SpeechVoiceCategoryTTSRate',
    'SPLOADOPTIONS', 'SPPS_RESERVED1', 'DISPID_SVSpeak',
    'DISPID_SVPause', 'DISPID_SPILanguageId', 'SVPOver',
    'SpeechVoiceSpeakFlags', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseElement', 'SAFTDefault', 'DISPID_SLPLangId',
    'SpWaveFormatEx', 'DISPID_SAFGuid', 'DISPID_SOTCEnumerateTokens',
    'ISpRecoGrammar2', 'DISPID_SRIsUISupported',
    'Speech_StreamPos_RealTime', 'SPCS_DISABLED', 'DISPID_SRGState',
    'SPPS_Interjection', 'SPPS_NotOverriden',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPEDisplayText', 'DISPID_SOTCDefault', 'SVP_10',
    'DISPID_SOTIsUISupported', 'DISPID_SPRuleNumberOfElements',
    'SDTReplacement', 'DISPID_SpeechPhoneConverter', 'ISpRecoContext',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechVisemeFeature',
    'DISPID_SOTId', 'DISPID_SPRNumberOfElements', 'ISpStreamFormat',
    'SGRSTTDictation', 'DISPID_SRCVoice', 'Speech_Default_Weight',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPAs_NewEnum',
    'SpeechCategoryAudioIn', 'SpStreamFormatConverter',
    'SAFTGSM610_44kHzMono', 'SpMMAudioOut',
    'ISpeechGrammarRuleStateTransition', 'ISpeechMMSysAudio',
    'SVSFParseAutodetect', 'DISPID_SPIStartTime',
    'eLEXTYPE_PRIVATE12', 'SRESoundStart',
    '_ISpeechRecoContextEvents', 'SpeechDisplayAttributes',
    'eLEXTYPE_PRIVATE2', 'ISpeechResourceLoader', 'ISpeechDataKey',
    'SECFIgnoreWidth', 'DISPID_SVSInputWordLength',
    'DISPID_SPIGetDisplayAttributes', 'SPCT_DICTATION',
    'SpeechRecoProfileProperties', 'ISpeechGrammarRule',
    'SPSHT_NotOverriden', 'SP_VISEME_4', 'SPWORDPRONUNCIATION',
    'SVPAlert', 'SPEI_UNDEFINED', 'SGDSActiveUserDelimited',
    'SpeechAudioState', 'DISPID_SOTs_NewEnum',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCEBookmark',
    'DISPID_SVVoice', 'eWORDTYPE_DELETED',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_USER_SHORTCUT',
    'SGLexicalNoSpecialChars', 'SRAExport',
    'SpeechCategoryRecognizers', 'SVP_17', 'SPINTERFERENCE',
    'DISPID_SRCERequestUI', 'SpCustomStream', 'SPPHRASEELEMENT',
    'DISPID_SRCERecognition', 'SVSFDefault', 'DISPID_SPCLangId',
    'DISPID_SRGCmdSetRuleState', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPRuleParent', 'SPRST_NUM_STATES',
    'DISPID_SPIEnginePrivateData',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SGRSTTWord',
    'IEnumSpObjectTokens', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVRate', 'DISPID_SLWWord',
    'SpeechTokenValueCLSID', 'SpeechRegistryLocalMachineRoot',
    'SPSTREAMFORMATTYPE', 'SpTextSelectionInformation',
    'ISpeechRecognizerStatus', 'SPAS_RUN', 'SPRST_ACTIVE',
    'DISPID_SLPs_NewEnum', 'DISPID_SPEsItem',
    'DISPID_SDKSetStringValue', 'SpShortcut',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRAddResource',
    'SAFT24kHz8BitStereo', 'DISPID_SLWType', 'DISPID_SGRSRule',
    'SREHypothesis', 'SDA_Two_Trailing_Spaces', 'SAFT44kHz8BitMono',
    'ISpeechPhraseInfo', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPEEngineConfidence', 'SPEI_HYPOTHESIS', 'SpeechWordType',
    'DISPID_SRState', 'ISpRecognizer2', 'SPEI_START_SR_STREAM',
    'ISpeechLexiconWords', 'SAFT12kHz16BitMono',
    ...
    'SVSFNLPMask', 'SLODynamic', 'DISPID_SVGetAudioInputs',
    'SPVPRI_ALERT', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPRECOSTATE', 'SPBO_TIME_UNITS', 'DISPID_SRCResume',
    'SAFT16kHz8BitMono', 'eLEXTYPE_LETTERTOSOUND', 'SRAImport',
    'DISPID_SRCEPhraseStart', 'SpeechCategoryPhoneConverters',
    'SPEI_SOUND_END', '_ISpeechVoiceEvents',
    'DISPID_SLAddPronunciation', 'DISPID_SRCRequestedUIType',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPPValue',
    'SPRECOGNIZERSTATUS', 'SpeechCategoryAudioOut', 'SRARoot',
    'DISPID_SVAudioOutputStream', 'DISPID_SASFreeBufferSpace',
    'SDTAlternates', 'SINoSignal', 'SPXRO_SML', 'UINT_PTR',
    'DISPID_SPRFirstElement', 'SAFT32kHz16BitStereo',
    'SPRECORESULTTIMES', 'DISPID_SRCEInterference', 'SREBookmark',
    'SPEI_RECO_OTHER_CONTEXT', 'SVF_None', 'SGSEnabled', 'SPSLMA',
    'SpPhraseInfoBuilder', 'DISPID_SpeechGrammarRule',
    'SVEVoiceChange', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SpeechPhraseInfo', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechLexicon', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SSSPTRelativeToStart', 'SPWORDTYPE', 'DISPID_SBSFormat',
    'SPWT_LEXICAL', 'DISPID_SPRuleFirstElement', 'SPEI_REQUEST_UI',
    'SAFTADPCM_44kHzMono', 'SSTTDictation', 'SPINTERFERENCE_NOSIGNAL',
    'ISpPhraseAlt', 'SVSFIsFilename', 'SVSFParseSapi',
    'SpeechDiscardType', 'ISpNotifySource',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPEI_RESERVED2',
    'DISPID_SVSLastBookmark', 'DISPID_SGRSTPropertyName',
    'SECLowConfidence', 'DISPID_SMSSetData', 'DISPID_SpeechVoice',
    'SSFMOpenReadWrite', 'SVEWordBoundary', 'SPAS_CLOSED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechPhraseReplacement', 'SP_VISEME_10', 'SPEI_MIN_TTS',
    'SpeechSpecialTransitionType', 'SAFT16kHz16BitStereo',
    'SP_VISEME_16', 'DISPID_SABIEventBias', 'SPPS_RESERVED4',
    'DISPID_SPIEngineId', 'SPRS_INACTIVE', 'DISPID_SGRSTransitions',
    'DISPID_SPISaveToMemory', 'DISPID_SRCVoicePurgeEvent',
    'SGDSInactive', 'DISPID_SRRTStreamTime',
    ...
    'DISPID_SDKDeleteKey', 'SWTAdded', 'SREAdaptation',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_RESERVED6',
    'ISpRecoCategory', 'DISPIDSPRG', 'SITooFast', '_SPAUDIOSTATE',
    'DISPID_SRCEAdaptation', 'SPGRAMMARSTATE', 'SRSActive',
    'ISpeechXMLRecoResult', 'SGSExclusive',
    'DISPID_SRGDictationUnload', 'SAFTADPCM_8kHzMono',
    'SPDKL_LocalMachine', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechRecoResultTimes', 'SRSInactive', 'SPPHRASEPROPERTY',
    'SVSFUnusedFlags', 'DISPID_SRGCommit', 'SPWF_SRENGINE',
    'SVESentenceBoundary', 'SSTTTextBuffer', 'SECFNoSpecialChars',
    'ISpeechPhraseRules', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRCRetainedAudio',
    'DISPID_SWFEFormatTag', 'DISPID_SVGetAudioOutputs',
    'SPXRO_Alternates_SML', 'DISPID_SRRecognizer', 'SDTAudio',
    'DISPID_SOTMatchesAttributes', 'DISPID_SDKSetLongValue',
    'DISPID_SOTsItem', 'SPPROPERTYINFO', 'tagSPTEXTSELECTIONINFO',
    '_RemotableHandle', 'ISpeechPhraseInfoBuilder', 'DISPID_SRGReset',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPIAudioSizeBytes',
    'SGDSActiveWithAutoPause', 'DISPID_SPPConfidence', 'SPSFunction',
    'SRSEDone', 'DISPID_SRCEventInterests', 'DISPID_SVSPhonemeId',
    'DISPID_SGRSTPropertyId', 'ISpeechGrammarRuleState',
    'DISPID_SRCESoundStart', 'SAFTCCITT_uLaw_22kHzMono',
    'SP_VISEME_1', 'SAFT11kHz8BitStereo', 'DISPID_SRRTTickCount',
    'DISPID_SPRuleName', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SABufferInfo', 'STCLocalServer', 'SVSFParseMask',
    'SFTInput', 'SPINTERFERENCE_LATENCY_WARNING', 'SpFileStream',
    'SpeechRecognitionType', 'DISPID_SRGetPropertyString',
    'SAFT32kHz8BitMono', 'SVEBookmark', 'DISPID_SpeechRecoResult',
    'tagSTATSTG', 'DISPID_SASCurrentSeekPosition', 'SPAUDIOOPTIONS',
    'DISPID_SOTDataKey', 'DISPID_SpeechCustomStream',
    'DISPID_SGRSTType', 'tagSPPROPERTYINFO', 'SpeechVisemeType',
    'DISPID_SLPsItem', 'DISPID_SRAudioInput', 'SPEI_RECOGNITION',
    'DISPID_SpeechAudioStatus', 'DISPID_SpeechAudioFormat',
    'SREFalseRecognition', 'SITooLoud',
    'DISPID_SRCEPropertyStringChange', 'SPSNoun', 'DISPID_SVResume',
    'DISPID_SPERetainedSizeBytes', 'SAFT8kHz8BitStereo',
    'IInternetSecurityManager', 'DISPID_SOTDisplayUI',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCPause',
    'SpeechLexiconType', 'DISPID_SRRAudioFormat',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRGRules',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVSInputWordPosition',
    'SPEI_SR_BOOKMARK', 'DISPID_SDKEnumKeys',
    'SpeechRetainedAudioOptions', 'DISPID_SLWLangId',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCState', 'DISPID_SOTCSetId',
    'eLEXTYPE_PRIVATE8', 'SpInprocRecognizer',
    'DISPID_SLGenerationId', 'SASRun', 'DISPID_SVEViseme',
    'eLEXTYPE_PRIVATE19', 'SVP_12', 'SpObjectTokenCategory',
    'SSSPTRelativeToEnd', 'SPSModifier', 'SPPARTOFSPEECH',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SWFEBlockAlign',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpRecognizer', 'SP_VISEME_17',
    'SPSNotOverriden', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPCIdToPhone', 'ISpeechPhoneConverter', 'STCInprocServer',
    'ISpeechPhraseProperty', 'DISPID_SLGetWords', 'SDKLCurrentUser',
    'SVSFNLPSpeakPunc', 'DISPID_SGRAddState',
    'ISpeechPhraseAlternates', 'SAFTADPCM_8kHzStereo',
    'ISpeechCustomStream', 'DISPID_SRCSetAdaptationData',
    'ISpeechPhraseAlternate', 'SPADAPTATIONRELEVANCE',
    'SpeechAudioProperties', 'DISPIDSPTSI_ActiveLength',
    'SRTSMLTimeout', 'SAFTCCITT_uLaw_8kHzMono', 'SPWF_INPUT',
    'SpeechAudioFormatGUIDText', 'STSF_CommonAppData',
    'SPEI_RESERVED5', 'SPLO_STATIC', 'ISpRecoResult',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPACommit',
    'SPPS_RESERVED2', 'DISPID_SLPType', 'SDTLexicalForm',
    'SPSEMANTICFORMAT', 'DISPID_SDKOpenKey',
    'SAFTExtendedAudioFormat', 'SPRULE', 'SPAUDIOSTATUS', 'STCAll',
    'SVP_5', 'SVP_8', 'SSFMCreate', 'SPAR_Low',
    'DISPID_SVEAudioLevel', 'SDTAll', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVEWord', 'SPVISEMES', 'SAFTCCITT_ALaw_44kHzMono',
    'SPWORDLIST', 'eLEXTYPE_PRIVATE11', 'DISPID_SRRAudio',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPRsCount', 'SREStreamStart',
    'DISPID_SAVolume', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPEPronunciation', 'SVF_Emphasis',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGDictationLoad',
    'DISPID_SVSkip', 'ISpMMSysAudio', 'ISpStream', 'SRTStandard',
    'SAFTCCITT_ALaw_44kHzStereo', 'SECFIgnoreKanaType',
    'SVEEndInputStream', 'DISPID_SGRSTPropertyValue',
    'ISpObjectWithToken', 'DISPID_SGRs_NewEnum', 'DISPID_SRIsShared',
    'ISpeechRecoContext', 'DISPID_SAFSetWaveFormatEx', 'SVP_18',
    'DISPID_SCSBaseStream', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpeechFileStream', 'DISPID_SRCEPropertyNumberChange',
    'SPEVENTSOURCEINFO', 'DISPID_SPAsCount', 'SpeechFormatType',
    'SAFT8kHz8BitMono', 'SRERequestUI', 'ISpeechRecognizer',
    'DISPID_SpeechVoiceEvent', 'SpNotifyTranslator',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechRecoResult2',
    'SGDSActive', 'SGPronounciation', 'SREAllEvents',
    'SPDKL_DefaultLocation', 'SRAONone', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT48kHz16BitStereo', 'DISPID_SPRuleId', 'SREStreamEnd',
    'DISPID_SLRemovePronunciation', 'SPPS_Modifier', 'SP_VISEME_6',
    'SAFT44kHz8BitStereo', 'SPPS_Noun', 'SGRSTTWildcard',
    'DISPID_SPRText', 'SAFT11kHz16BitStereo', 'SGDisplay',
    'DISPID_SGRName', 'SpLexicon', 'ISpLexicon', 'SPSERIALIZEDRESULT',
    ...
    'SVEAllEvents', 'SAFT24kHz16BitMono', 'ISpeechAudio', 'SVP_16',
    'SPLO_DYNAMIC', 'SpeechAllElements', 'SVP_11', 'SPGS_EXCLUSIVE',
    'SPSHORTCUTTYPE', 'SREStateChange', 'SECFIgnoreCase',
    'eLEXTYPE_RESERVED8', 'SPEI_RESERVED1', 'SPFM_OPEN_READONLY',
    'SpeechGrammarState', 'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE17',
    'SPWORDPRONOUNCEABLE', 'SP_VISEME_11',
    'DISPID_SRRTOffsetFromStart', 'SpMemoryStream', 'SPFM_NUM_MODES',
    'DISPID_SRSClsidEngine', 'DISPID_SPIGrammarId',
    'eLEXTYPE_RESERVED4', 'SpeechStreamFileMode',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT22kHz8BitMono',
    'IInternetSecurityMgrSite', 'SAFT32kHz8BitStereo',
    'eLEXTYPE_PRIVATE7', 'DISPID_SpeechPhraseReplacements',
    'SPINTERFERENCE_NONE', 'SPCT_SUB_DICTATION',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCCreateGrammar', 'SPPS_Verb',
    'DISPID_SRGCmdLoadFromResource', 'SP_VISEME_7',
    'DISPID_SRCBookmark', 'SVEAudioLevel', 'SAFT8kHz16BitMono',
    'SAFTADPCM_11kHzStereo', 'SREAudioLevel',
    'SpeechRecoContextState', 'DISPID_SPPId', 'DISPID_SPAsItem',
    'DISPID_SRRDiscardResultInfo', 'SPTEXTSELECTIONINFO', 'SPSMF_UPS',
    'SDTDisplayText', 'SVF_Stressed', 'SpeechAudioFormatType',
    'SpeechRegistryUserRoot', 'SpeechPropertyAdaptationOn',
    'eLEXTYPE_RESERVED9', 'ISpeechPhraseRule', 'SpMMAudioIn',
    'ISpeechRecoResultDispatch', 'SAFTADPCM_44kHzStereo', 'SPSVerb',
    'DISPID_SRGCmdLoadFromFile', 'SPCT_SLEEP', 'ISpXMLRecoResult',
    'DISPID_SLPPhoneIds', 'SpeechAddRemoveWord',
    'DISPID_SLPPartOfSpeech', 'DISPID_SGRsItem', 'ISpeechVoice',
    'SpeechTokenIdUserLexicon', 'SBOPause', 'DISPID_SPPsItem',
    'DISPID_SVSpeakCompleteEvent', 'eLEXTYPE_PRIVATE1',
    'Speech_StreamPos_Asap', 'DISPID_SGRId', 'SpeechGrammarWordType',
    'SPBO_AHEAD', 'SpeechPropertyComplexResponseSpeed',
    'SPGS_ENABLED', 'SpPhoneConverter', 'SpeechCategoryVoices',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRCESoundEnd', 'SPAO_NONE',
    'DISPID_SpeechPhraseProperty', 'DISPID_SOTGetAttribute',
    'DISPID_SPPEngineConfidence', 'SVP_15', 'SAFT12kHz8BitMono',
    'SpeechPropertyResponseSpeed', 'SPSEMANTICERRORINFO',
    'SAFT48kHz8BitStereo', 'SVPNormal', 'DISPID_SOTsCount',
    'DISPID_SGRAttributes', 'SP_VISEME_20',
    'DISPID_SRCRetainedAudioFormat', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT16kHz16BitMono',
    'DISPID_SRSAudioStatus', 'SPSHORTCUTPAIR', 'SASPause',
    'SPEI_RESERVED3', 'DISPID_SGRInitialState', 'SRADefaultToActive',
    'ISpeechBaseStream', 'SAFT12kHz8BitStereo', 'SAFTGSM610_8kHzMono',
    ...
    'DISPID_SGRsCount', 'DISPID_SVAlertBoundary', 'SVP_9',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVPriority', 'DISPID_SPCPhoneToId', 'SAFT48kHz8BitMono',
    'SSFMCreateForWrite', 'DISPID_SWFEExtraData',
    'DISPID_SpeechWaveFormatEx', 'ISpDataKey', 'DISPID_SGRsAdd',
    'SASClosed', 'SPVPRI_NORMAL', 'SVSFParseSsml',
    'DISPID_SVSInputSentencePosition', 'SPWAVEFORMATTYPE',
    'DISPID_SRRRecoContext', 'DISPID_SBSWrite', 'SINone',
    'SPEI_MAX_SR', 'SAFTTrueSpeech_8kHz1BitMono', 'ISpNotifySink',
    'DISPIDSPTSI_ActiveOffset', 'SPLEXICONTYPE', 'SPEI_RESERVED6',
    'DISPID_SPRulesCount', 'SPFILEMODE', 'SVEViseme', 'SP_VISEME_15',
    'SPGS_DISABLED', 'DISPID_SpeechLexicon', 'SVP_7',
    'SPDKL_CurrentConfig', 'SRSActiveAlways', 'ISpAudio',
    'DISPID_SLWsItem', 'SPBOOKMARKOPTIONS', 'SPAUDIOBUFFERINFO',
    'ISpRecoContext2', 'SRTEmulated', 'DISPID_SpeechObjectToken',
    'SP_VISEME_2', 'DISPID_SBSRead', 'DISPID_SRDisplayUI',
    'SpInProcRecoContext', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPEs_NewEnum', 'SpeechStreamSeekPositionType', 'SVP_4',
    'DISPID_SpeechObjectTokens', 'ISpRecoGrammar',
    'ISpeechAudioBufferInfo', 'SAFTCCITT_uLaw_11kHzMono',
    'SPDATAKEYLOCATION', 'DISPID_SPRs_NewEnum', 'DISPID_SGRSTsCount',
    'SpStream', 'SPEI_PHRASE_START', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SDKEnumValues', 'SpMMAudioEnum', 'ISpeechRecoResult2',
    'ISpPhrase', 'SSTTWildcard', 'DISPID_SRGSetTextSelection',
    'DISPID_SVESentenceBoundary', 'SVSFPersistXML', 'SSFMOpenForRead',
    'SDA_No_Trailing_Space', 'DISPID_SVWaitUntilDone',
    'SAFT11kHz8BitMono', 'SRAORetainAudio',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRSetPropertyNumber',
    'SDTProperty', 'ISpGrammarBuilder', 'WAVEFORMATEX', 'SPAR_Medium',
    'SVEPhoneme', 'SRESoundEnd', 'SPEI_VOICE_CHANGE', 'SVSFIsNotXML',
    'SPAUDIOSTATE', 'SPINTERFERENCE_TOOSLOW',
    ...
    'SPRS_ACTIVE', 'STCRemoteServer', 'SPAR_Unknown'
]

_check_version('1.1.14', 1660026550.156889)
