...
__all__ = [
    'SAFT44kHz8BitStereo', 'SAFTADPCM_8kHzStereo', 'SLTApp',
    'SP_VISEME_12', 'SPSHT_EMAIL', 'SVSFIsNotXML',
    'DISPID_SpeechPhraseAlternates',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT48kHz8BitStereo',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SWFEBitsPerSample',
    'SPEI_TTS_PRIVATE', 'DISPID_SVEBookmark', 'DISPID_SRCESoundStart',
    'eLEXTYPE_PRIVATE2', 'SAFT11kHz16BitStereo', 'SGLexical',
    'SGDSInactive', 'DISPID_SPCIdToPhone', 'SPVPRI_OVER',
    'DISPID_SpeechPhraseReplacements', 'ISpeechDataKey',
    'SPRECOSTATE', 'SPPARTOFSPEECH', 'SAFT8kHz8BitMono',
    'DISPID_SPRDisplayAttributes', 'DISPID_SMSADeviceId',
    'DISPID_SPPFirstElement', 'DISPID_SLGenerationId',
    'ISpeechRecoGrammar', 'DISPID_SPIGetDisplayAttributes',
    'SPWORDTYPE', 'SRERecoOtherContext', 'SVP_18',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SpeechPhraseRule',
    'DISPID_SVWaitUntilDone', 'DISPID_SPELexicalForm',
    'SDA_One_Trailing_Space', 'SGSExclusive', 'DISPID_SRGReset',
    'DISPID_SDKSetStringValue',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SGDSActiveUserDelimited', 'SPAUDIOSTATE', 'SPVPRI_NORMAL',
    'DISPID_SPAPhraseInfo', 'SPEI_SR_AUDIO_LEVEL', 'SREAllEvents',
    'DISPID_SOTDisplayUI', 'DISPID_SOTCreateInstance', 'STCAll',
    'SpeechCategoryAudioIn', 'eLEXTYPE_PRIVATE16', 'SSTTTextBuffer',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPRuleName', 'SPSLMA',
    'ISpDataKey', 'SpeechAudioProperties', 'SP_VISEME_21',
    'eLEXTYPE_PRIVATE15', 'SP_VISEME_3', 'DISPID_SDKCreateKey',
    'SVSFPersistXML', 'SVSFParseAutodetect',
    'DISPID_SOTGetStorageFileName',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SRStatus',
    'DISPID_SVGetAudioInputs', 'SPAR_Low', 'DISPIDSPTSI',
    'eLEXTYPE_PRIVATE5', 'SpMMAudioIn', 'SpWaveFormatEx',
    'DISPID_SRDisplayUI', 'DISPID_SRRSaveToMemory',
    'DISPID_SVEStreamStart', 'ISpeechGrammarRule',
    'SAFT44kHz8BitMono', 'SPWORD', 'SPINTERFERENCE_NOSIGNAL', 'SVP_6',
    'SPDKL_LocalMachine', 'SGPronounciation', 'SpeechRuleAttributes',
    'ISpeechAudioBufferInfo', 'SPSSuppressWord', 'DISPID_SGRsDynamic',
    'ISpObjectTokenCategory', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVPause', 'DISPID_SRRTStreamTime',
    'SpeechPropertyResponseSpeed', 'DISPID_SLWType', 'SVF_Emphasis',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRGRecoContext', 'SAFTText',
    'DISPID_SRRTimes', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLPPhoneIds', 'SpeechDataKeyLocation', 'DISPID_SGRClear',
    'tagSTATSTG', 'DISPID_SPRText', 'ISpProperties',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRRTOffsetFromStart', 'SPWORDPRONUNCIATIONLIST',
    'SRTStandard', 'SVP_5', 'SREInterference', 'LONG_PTR',
    'SPEI_MAX_SR', 'STCInprocServer', 'DISPID_SABIMinNotification',
    'DISPID_SGRSTText', 'DISPID_SpeechRecognizerStatus',
    'SpeechSpecialTransitionType', 'DISPID_SVESentenceBoundary',
    'SP_VISEME_16', 'ISpAudio', 'SVP_0', 'SPFM_OPEN_READONLY',
    'SGLexicalNoSpecialChars', 'DISPID_SRCVoice', 'DISPID_SPIGetText',
    'DISPID_SVSInputWordPosition', 'SVP_3', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRRPhraseInfo', 'SPWORDLIST', 'DISPID_SOTCId',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SGRSAddRuleTransition', 'SpeechTokenKeyFiles',
    'DISPID_SLAddPronunciation', 'SASClosed', 'DISPID_SOTs_NewEnum',
    'DISPID_SVGetAudioOutputs', 'SDKLLocalMachine',
    'DISPID_SVSpeakStream', 'SPEI_SR_BOOKMARK', 'SpeechVoicePriority',
    'DISPID_SRCEAudioLevel', 'SAFTCCITT_uLaw_8kHzStereo',
    'SREAudioLevel', 'SAFTGSM610_11kHzMono', 'SGRSTTRule',
    'DISPID_SRCEPhraseStart', 'IStream',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SGRsItem',
    'ISpRecognizer', 'DISPID_SGRSTWeight', 'SpeechWordPronounceable',
    'ISpeechGrammarRules', 'SAFTGSM610_22kHzMono',
    'SPEI_SENTENCE_BOUNDARY', 'SLTUser', 'ISpeechPhraseProperties',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVSpeakCompleteEvent',
    'SVEPrivate', 'DISPID_SGRAddResource', 'ISpGrammarBuilder',
    'SVP_21', 'SAFTNoAssignedFormat', 'DISPID_SPPChildren',
    'ISpObjectToken', 'SAFTCCITT_ALaw_44kHzMono', '_SPAUDIOSTATE',
    'SRSInactive', 'SASStop', 'DISPID_SPEActualConfidence',
    'SpSharedRecognizer', 'ISpeechBaseStream', 'SSTTDictation',
    'DISPID_SRRTLength', 'DISPID_SPRuleEngineConfidence',
    'SpPhraseInfoBuilder', 'IInternetSecurityMgrSite',
    'SpeechFormatType', 'SP_VISEME_2', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechWaveFormatEx', 'ISpeechPhraseRules',
    'DISPID_SRRAudioFormat', 'DISPID_SPCLangId', 'SPBO_AHEAD',
    'SPAS_STOP', 'SpMMAudioOut', 'DISPID_SRCEEndStream',
    'DISPID_SASetState', 'SREAdaptation', 'DISPID_SpeechVoiceEvent',
    'SDTRule', 'ISpeechMMSysAudio', 'SVEVoiceChange',
    'ISpeechCustomStream', 'DISPID_SPRules_NewEnum', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRInitialState',
    'SPAR_Unknown', 'SPSMF_SRGS_SAPIPROPERTIES', 'SITooFast',
    'SPWF_INPUT', 'ISpeechObjectTokenCategory', 'SPTEXTSELECTIONINFO',
    'SRESoundEnd', 'SPEI_VOICE_CHANGE', 'DISPID_SBSWrite',
    'SVF_Stressed', 'SVEBookmark', 'SpeechRecognitionType',
    'eLEXTYPE_RESERVED8', 'SDTDisplayText', 'SPFM_OPEN_READWRITE',
    'ISpeechRecognizerStatus', 'DISPID_SpeechLexiconProns',
    'SPVPRI_ALERT', 'DISPID_SPEAudioSizeBytes', 'SPGS_EXCLUSIVE',
    'DISPID_SPARecoResult', 'DISPID_SpeechLexiconWord',
    'SpCompressedLexicon', 'DISPID_SRCEBookmark',
    'DISPID_SPPConfidence', 'SpeechGrammarWordType',
    'SpeechRecoEvents', 'SPSHORTCUTPAIRLIST', 'SP_VISEME_18',
    'DISPID_SpeechXMLRecoResult', 'SPEVENT', 'DISPID_SGRSTransitions',
    'DISPID_SPIElements', 'DISPID_SRCRetainedAudio',
    'DISPID_SGRSTType', 'SAFT12kHz16BitStereo',
    'DISPID_SPRuleNumberOfElements', 'SpeechBookmarkOptions',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRName', 'SPXRO_SML',
    'SVP_13', 'SpeechCategoryAudioOut', 'DISPID_SPPParent',
    'SAFT22kHz8BitMono', 'SpeechCategoryVoices', 'SVP_1',
    'DISPID_SpeechGrammarRuleState', 'UINT_PTR',
    'SPDKL_DefaultLocation', 'DISPID_SpeechPhraseReplacement',
    'SPCT_COMMAND', 'DISPID_SGRsAdd', 'eLEXTYPE_PRIVATE17',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGCommit', 'SPVISEMES',
    'SINoSignal', 'DISPID_SVEVoiceChange', 'SVPNormal', 'SECFDefault',
    'SpNullPhoneConverter', 'ISpeechLexiconWord',
    'DISPID_SpeechRecoResult', 'DISPID_SPEAudioStreamOffset',
    'SVEAllEvents', 'SAFT24kHz16BitStereo', 'SPPHRASEPROPERTY',
    'SPEI_SOUND_END', 'SPEI_RESERVED3', 'SPVOICESTATUS',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpRecoResult', 'ISpPhraseAlt',
    'SDTProperty', 'SPEI_HYPOTHESIS', 'SINoise', 'STSF_FlagCreate',
    'SWPUnknownWordPronounceable', 'SpeechAddRemoveWord',
    'DISPID_SVAlertBoundary', 'DISPID_SVEViseme', 'SPEI_RECOGNITION',
    'SPEI_START_SR_STREAM', 'SP_VISEME_9', 'SRTEmulated',
    ...
    'DISPID_SPRuleId', 'DISPID_SpeechVoice', 'ISpPhoneConverter',
    'ISpRecoCategory', 'SWTDeleted', 'DISPID_SDKSetLongValue',
    'DISPID_SVDisplayUI', 'STCInprocHandler', 'eLEXTYPE_APP',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_LETTERTOSOUND',
    'SPSERIALIZEDRESULT', 'SAFTADPCM_11kHzMono', 'SPAR_High',
    'SPPROPERTYINFO', 'SPGS_DISABLED', 'SPRECORESULTTIMES',
    'DISPID_SOTCDefault', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SDKOpenKey', 'DISPID_SpeechBaseStream',
    'SPSEMANTICERRORINFO', 'SAFT22kHz8BitStereo', 'SPPS_RESERVED1',
    'DISPID_SRGDictationSetState', 'SAFT8kHz8BitStereo',
    'DISPID_SMSALineId', 'DISPID_SGRAttributes', 'SPPHRASE',
    'SAFTNonStandardFormat', 'DISPID_SVSRunningState',
    'SpeechTokenKeyAttributes', 'SPPS_NotOverriden', 'SPBO_NONE',
    'SAFTDefault', 'SVSFlagsAsync', 'ISpeechLexiconPronunciations',
    'SREPrivate', 'DISPID_SLWsItem', 'DISPID_SpeechAudioStatus',
    'ISpeechLexiconWords', 'DISPID_SPEPronunciation',
    'eWORDTYPE_DELETED', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRCEInterference', 'SPWORDPRONUNCIATION', 'SVPOver',
    'SPEVENTSOURCEINFO', 'DISPID_SVEWord', 'SGDSActiveWithAutoPause',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRId',
    'DISPID_SpeechGrammarRules', 'WAVEFORMATEX', 'DISPID_SBSRead',
    'DISPID_SVSVisemeId', 'SPPHRASERULE', 'DISPID_SRGDictationUnload',
    'SpUnCompressedLexicon', 'SP_VISEME_7', 'SPEI_ADAPTATION',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SLWPronunciations',
    'SAFT16kHz16BitMono', 'DISPID_SRRAlternates', 'SP_VISEME_5',
    'DISPID_SPIStartTime', 'ISpRecoContext2',
    'DISPID_SRCCreateGrammar', 'DISPID_SWFESamplesPerSec',
    'SpFileStream', 'DISPID_SpeechRecoContext', 'SPEI_UNDEFINED',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SLGetPronunciations',
    'SpeechGrammarTagDictation', 'SPSNotOverriden',
    'eLEXTYPE_PRIVATE3', 'SpShortcut', 'eLEXTYPE_PRIVATE4',
    'SGSEnabled', 'SVSFParseSapi', 'ISpeechPhraseAlternate',
    'SpeechCategoryPhoneConverters', 'SPCT_SUB_DICTATION', 'SRSEDone',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSHORTCUTTYPE', 'SPEI_REQUEST_UI',
    'SPWAVEFORMATTYPE', 'DISPID_SVSLastBookmarkId',
    'Speech_Max_Word_Length', 'DISPID_SRGCmdSetRuleState',
    'STSF_AppData', 'SPEVENTENUM', 'SP_VISEME_10', 'DISPID_SPEsItem',
    'SPVPRIORITY', 'DISPID_SPRulesItem', 'SpeechMicTraining',
    'DISPID_SPIEngineId', 'SVP_4', 'DISPID_SRGState',
    ...
    'DISPID_SVEEnginePrivate', 'SpeechRecognizerState',
    'DISPID_SPIAudioSizeBytes', 'SVP_11', 'DISPID_SDKGetStringValue',
    'DISPID_SRIsUISupported', 'SWTAdded', 'DISPID_SPRuleChildren',
    'DISPID_SpeechObjectToken', 'SPWORDPRONOUNCEABLE', 'SRCS_Enabled',
    'ISpPhoneticAlphabetSelection', 'SVP_8', 'SVP_17', 'ISpLexicon',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechTokenShellFolder',
    '_ISpeechRecoContextEvents', 'SBONone',
    'SAFTCCITT_uLaw_11kHzStereo', 'SSFMOpenReadWrite',
    'DISPID_SRCERecognition', 'ISpeechWaveFormatEx',
    'SPEI_RECO_STATE_CHANGE', 'SpeechVoiceEvents', '_RemotableHandle',
    'SpeechVisemeType', 'SAFT48kHz16BitStereo', 'ISpeechFileStream',
    'ISequentialStream', 'SPWT_PRONUNCIATION', 'SDTReplacement',
    'DISPID_SWFEChannels', 'DISPID_SRRDiscardResultInfo',
    'SREHypothesis', 'SPAS_CLOSED', 'DISPID_SREmulateRecognition',
    'SpeechTokenKeyUI', 'ISpeechPhraseElements', 'SP_VISEME_20',
    'SPEI_RESERVED2', 'SSTTWildcard', 'DISPID_SGRSTPropertyName',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RESERVED6', 'SPFILEMODE',
    'SAFTGSM610_44kHzMono', 'DISPID_SOTId', 'SAFTADPCM_22kHzMono',
    ...
    'DISPID_SDKDeleteKey', 'Speech_Max_Pron_Length', 'SVSFIsFilename',
    'SpTextSelectionInformation', 'ISpPhoneticAlphabetConverter',
    'SAFT32kHz8BitStereo', 'IInternetSecurityManager',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpStreamFormat',
    'SPDKL_CurrentConfig', 'DISPID_SVSLastResult', 'SLODynamic',
    'DISPID_SRAudioInput', 'DISPID_SpeechCustomStream',
    'SDTPronunciation', 'DISPID_SVSpeak', 'SP_VISEME_6',
    'SRAORetainAudio', 'DISPID_SOTRemoveStorageFileName',
    'SAFT11kHz16BitMono', 'SpeechGrammarTagUnlimitedDictation',
    'SINone', 'SAFT12kHz8BitStereo', 'SSSPTRelativeToCurrentPosition',
    'SPPHRASEREPLACEMENT', '__MIDL_IWinTypes_0009',
    'DISPID_SPIRetainedSizeBytes', 'SVEAudioLevel', 'SPSUnknown',
    'SPDATAKEYLOCATION', 'DISPID_SOTDataKey',
    'DISPID_SpeechPhraseElement', '_ISpeechVoiceEvents', 'SDTAudio',
    ...
    'eLEXTYPE_PRIVATE10', 'DISPID_SPEs_NewEnum', 'eLEXTYPE_RESERVED9',
    'SECHighConfidence', 'DISPID_SRGetPropertyString',
    'DISPID_SPERetainedStreamOffset',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechLexiconPronunciation', 'SP_VISEME_11', 'SVP_10',
    ...
    'SpVoice', 'SPEI_TTS_BOOKMARK', 'SpeechRunState', 'SRERequestUI',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCBookmark',
    'DISPID_SpeechPhoneConverter', 'ISpeechRecoResultDispatch',
    'SRTExtendableParse', 'DISPID_SPERequiredConfidence',
    'SAFT11kHz8BitMono', 'SPEI_INTERFERENCE',
    'DISPID_SRSCurrentStreamNumber', 'SPLEXICONTYPE',
    'DISPID_SVAudioOutputStream', 'ISpeechAudioFormat', 'SVPAlert',
    'STCLocalServer', 'Speech_Default_Weight',
    'SpeechRecoContextState', 'SECFIgnoreWidth',
    'DISPID_SGRsFindRule', 'DISPID_SpeechDataKey', 'SRTReSent',
    'SpResourceManager', 'tagSPTEXTSELECTIONINFO',
    'SPEI_SR_RETAINEDAUDIO', 'SPSHT_OTHER',
    'DISPID_SRGCmdLoadFromResource', 'SDKLCurrentUser',
    'ISpNotifySource', 'ISpeechRecoResult', 'SGRSTTTextBuffer',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE6',
    'DISPID_SLWs_NewEnum', 'DISPID_SOTGetDescription',
    'SpeechEmulationCompareFlags', 'DISPID_SWFEFormatTag',
    ...
    'SpeechAudioState', 'SPDKL_CurrentUser', 'SPEI_VISEME',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SAVolume',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SCSBaseStream',
    'eLEXTYPE_USER', 'SECFIgnoreKanaType', 'DISPID_SWFEBlockAlign',
    ...
    'SpeechAudioFormatGUIDText', 'SGDisplay',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRIsShared', 'SVP_19',
    'DISPID_SPRsCount', 'SpeechTokenValueCLSID', 'SAFT48kHz8BitMono',
    'DISPID_SGRSTPropertyValue', 'SAFT16kHz8BitStereo',
    'SPAUDIOBUFFERINFO', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRProfile', 'SpObjectTokenCategory',
    'DISPID_SpeechGrammarRule', 'DISPID_SVAudioOutput',
    'DISPID_SASState', 'SPRST_NUM_STATES', 'DISPID_SPCPhoneToId',
    'ISpeechLexiconPronunciation', 'SPCT_SUB_COMMAND',
    'SAFT22kHz16BitMono', 'DISPID_SADefaultFormat', 'SRERecognition',
    'SRCS_Disabled', 'DISPID_SRCResume', 'ISpeechPhraseInfoBuilder',
    'SRAImport', 'SPGRAMMARSTATE', 'DISPID_SPAsCount',
    'SAFT32kHz16BitMono', 'SPEI_START_INPUT_STREAM',
    'DISPID_SGRSTRule', 'DISPID_SAFGuid', 'SPEI_PHONEME',
    'ISpeechAudioStatus', 'ISpeechPhraseElement', 'SpAudioFormat',
    'SpeechPartOfSpeech', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRAddState', 'SFTInput', 'DISPID_SPIRule',
    'DISPID_SPIReplacements', 'SVP_15', 'SPINTERFERENCE_NONE',
    'SpeechWordType', 'DISPID_SBSFormat',
    'SpeechStreamSeekPositionType', 'ISpeechRecognizer',
    'SRSEIsSpeaking', 'SpeechLoadOption', 'SpeechCategoryRecognizers',
    'DISPID_SPAsItem', 'DISPID_SVEventInterests',
    'SREPropertyStringChange', 'DISPID_SVSkip', 'SPPS_Unknown',
    'ISpStreamFormatConverter', 'SPRST_ACTIVE_ALWAYS',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechGrammarRuleStateTransitionType',
    'SAFT44kHz16BitMono', 'ISpEventSource',
    'DISPID_SDKGetBinaryValue', 'SPGS_ENABLED', 'SPWF_SRENGINE',
    'SPRECOGNIZERSTATUS', 'DISPID_SGRs_NewEnum', 'DISPID_SLPsItem',
    'SPEI_MIN_TTS', 'SPEI_RESERVED5', 'DISPID_SVGetProfiles',
    'DISPID_SPACommit', 'SpeechDictationTopicSpelling',
    'SPEI_SOUND_START', 'SAFT24kHz8BitStereo',
    'DISPID_SVSInputSentenceLength', 'SPBO_TIME_UNITS', 'SVF_None',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechPhraseProperties',
    'DISPID_SVVoice', 'DISPID_SVEStreamEnd',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_MORPHOLOGY', 'SVSFDefault',
    'DISPID_SOTRemove', 'DISPID_SGRsCount', 'SRARoot',
    'DISPID_SGRSAddWordTransition', 'SP_VISEME_19',
    'DISPID_SLWsCount', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SLPs_NewEnum', 'SPBOOKMARKOPTIONS',
    'DISPID_SRCEAdaptation', 'DISPID_SASNonBlockingIO', 'SVP_12',
    'SpeechGrammarState', 'SVP_16', 'SPPS_Noun',
    'DISPID_SLPPartOfSpeech', 'SP_VISEME_4', 'SITooSlow',
    'DISPID_SPAs_NewEnum', 'ISpShortcut', 'DISPID_SRRSpeakAudio',
    'SP_VISEME_8', 'ISpeechXMLRecoResult', 'SpeechTokenContext',
    'SRADynamic', 'DISPID_SRCERecognitionForOtherContext',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPEDisplayText', 'SPPS_Modifier',
    'DISPID_SPPId', 'SRESoundStart', 'SPAS_PAUSE', 'ISpMMSysAudio',
    'DISPID_SPISaveToMemory', 'SECFNoSpecialChars', 'SVEWordBoundary',
    'DISPID_SOTsCount', 'SAFTADPCM_44kHzStereo', 'SGRSTTWildcard',
    'SRAExport', 'SREStateChange', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SOTCEnumerateTokens', 'SPWT_LEXICAL', 'SITooQuiet',
    ...
    'DISPID_SVGetVoices', 'SAFT22kHz16BitStereo',
    'DISPID_SABIEventBias', 'SVSFUnusedFlags', 'eLEXTYPE_RESERVED10',
    'SDTLexicalForm', 'SPCS_DISABLED',
    'ISpeechGrammarRuleStateTransition', 'SpeechVoiceCategoryTTSRate',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPPValue',
    'SPPHRASEELEMENT', 'SAFTADPCM_22kHzStereo', 'DISPID_SPRulesCount',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPILanguageId', 'SPCT_SLEEP',
    ...
    'DISPID_SGRsCommitAndSave', 'SRAONone', 'DISPID_SFSOpen',
    'ISpeechRecoContext', 'SpeechInterference',
    'ISpeechResourceLoader', 'DISPID_SAEventHandle',
    'DISPID_SASFreeBufferSpace', 'SpeechRecoProfileProperties',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRState',
    'SPSMF_UPS', 'eLEXTYPE_PRIVATE1', 'ISpRecoGrammar', 'SPFM_CREATE',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPRsItem', 'DISPIDSPRG',
    'SPPS_Function', 'DISPID_SABufferNotifySize',
    'SAFTCCITT_uLaw_8kHzMono', 'SRSInactiveWithPurge',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGCmdLoadFromMemory',
    'SGRSTTWord', 'SRTSMLTimeout', 'ISpeechObjectToken',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRCPause',
    'DISPID_SpeechLexiconWords', 'DISPIDSPTSI_ActiveLength',
    'SPCT_DICTATION', 'ISpeechObjectTokens', 'SpeechLexiconType',
    'SPEI_END_SR_STREAM', 'DISPID_SRCVoicePurgeEvent', 'SVP_9',
    'SVEEndInputStream', 'tagSPPROPERTYINFO', 'SVP_14',
    'ISpeechPhraseInfo', 'SPRS_INACTIVE',
    'DISPID_SRGSetWordSequenceData', 'SAFTCCITT_uLaw_22kHzStereo',
    'SRSActiveAlways', 'DISPID_SPPs_NewEnum', 'DISPID_SGRSTsItem',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SFSClose',
    'SPSMF_SAPI_PROPERTIES', 'ISpRecognizer3', 'DISPID_SRGId',
    ...
    'DISPID_SRRGetXMLResult', 'ISpNotifyTranslator', 'SPRULE',
    'ISpeechMemoryStream', 'SVSFIsXML', 'DISPID_SVStatus',
    'SECLowConfidence', 'DISPID_SOTMatchesAttributes',
    'STSF_CommonAppData', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRCEEnginePrivate', 'SREPhraseStart',
    'DISPID_SMSAMMHandle', 'SAFT32kHz16BitStereo', 'SBOPause',
    'SVESentenceBoundary', 'SASPause', 'SPWT_DISPLAY',
    'DISPID_SGRSAddSpecialTransition', 'SP_VISEME_15',
    'SPPS_Noncontent', 'DISPID_SAStatus', 'DISPID_SBSSeek',
    'SSFMOpenForRead', 'ISpeechPhraseProperty',
    'DISPID_SRAudioInputStream', 'DISPID_SPRFirstElement',
    'SpeechAllElements', 'DISPID_SRGetPropertyNumber',
    'SAFT24kHz8BitMono', 'DISPID_SpeechAudio', 'SpMemoryStream',
    'SPRST_ACTIVE', 'SpInProcRecoContext', 'STCRemoteServer',
    'SpeechRegistryUserRoot', 'DISPID_SPRuleConfidence',
    'SpMMAudioEnum', 'DISPID_SPIGrammarId', 'SpeechEngineProperties',
    'DISPID_SpeechObjectTokens', 'SPLO_DYNAMIC',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGetFormat',
    'DISPID_SRGIsPronounceable', 'SAFTExtendedAudioFormat',
    'SAFT8kHz16BitStereo', 'DISPID_SVSLastStreamNumberQueued',
    'eWORDTYPE_ADDED', 'DISPID_SPEsCount', 'SVEStartInputStream',
    'SPLOADOPTIONS', 'eLEXTYPE_PRIVATE13',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPXMLRESULTOPTIONS',
    'ISpSerializeState', 'ISpObjectWithToken', 'SPSHORTCUTPAIR',
    'SAFT32kHz8BitMono', 'SSSPTRelativeToEnd', 'DISPID_SVRate',
    'DISPID_SGRSTs_NewEnum', 'SGSDisabled', 'SPEI_MAX_TTS',
    'SPAO_NONE', 'SRATopLevel', 'DISPID_SpeechPhraseElements',
    'ISpeechRecoResultTimes', 'DISPID_SLPLangId',
    'DISPID_SLPSymbolic', 'ISpeechPhraseAlternates',
    'ISpeechPhraseRule', 'SPCONTEXTSTATE', 'SDTAlternates',
    'SPINTERFERENCE_NOISE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'eLEXTYPE_PRIVATE9', 'SVEViseme', 'SPPS_Verb',
    'DISPID_SRCEHypothesis', 'SWPKnownWordPronounceable',
    'DISPID_SRGRules', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SOTSetId',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SMSGetData',
    'DISPID_SVSPhonemeId', 'SASRun',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechFileStream', 'SPSEMANTICFORMAT', 'SP_VISEME_17',
    'DISPID_SABufferInfo', 'ISpeechTextSelectionInformation',
    'SREStreamStart', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eLEXTYPE_PRIVATE8', 'SPPS_RESERVED2', 'SAFT24kHz16BitMono',
    'SVSFVoiceMask', 'ISpEventSink', 'SPSVerb', 'SGDSActive',
    'SP_VISEME_0', 'DISPID_SRRAudio', 'SPRS_ACTIVE', 'SDTAll',
    'SREBookmark', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_FALSE_RECOGNITION', 'ISpNotifySink', 'eLEXTYPE_PRIVATE11',
    'ISpStream', 'SpeechEngineConfidence', 'Speech_StreamPos_Asap',
    'SVSFNLPSpeakPunc', 'SLOStatic', 'DISPID_SRRSetTextFeedback',
    'SPSHT_NotOverriden', 'SDKLCurrentConfig', 'DISPID_SPIProperties',
    'DISPID_SRGetRecognizers', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechPhraseReplacement', 'SDKLDefaultLocation',
    'DISPID_SRRRecoContext', 'ISpResourceManager', 'SPRST_INACTIVE',
    'DISPID_SRSetPropertyString', 'SPPS_Interjection',
    'DISPID_SRCState', 'SPAS_RUN', 'SPAUDIOOPTIONS',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SpeechPhraseRules',
    'SDA_Consume_Leading_Spaces', 'SPFM_CREATE_ALWAYS',
    'SVSFParseMask', 'SPEI_MIN_SR', 'SPSNoun', 'SpSharedRecoContext',
    'SpeechVoiceSkipTypeSentence', 'SREStreamEnd',
    'DISPID_SRSAudioStatus', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SMSSetData',
    'ISpeechVoiceStatus', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechPropertyResourceUsage', 'SPPS_SuppressWord',
    'eLEXTYPE_RESERVED4', 'SP_VISEME_1', 'SPGRAMMARWORDTYPE',
    ...
    'DISPID_SLWLangId', 'DISPID_SGRsCommit',
    ...
    'SpeechTokenIdUserLexicon', 'SPXRO_Alternates_SML', 'SPPS_LMA',
    'DISPID_SRCAudioInInterferenceStatus', 'SPPS_RESERVED3',
    'DISPID_SAFType', 'SpPhoneticAlphabetConverter',
    'SpeechGrammarTagWildcard', 'SAFTCCITT_ALaw_11kHzMono',
    'eLEXTYPE_PRIVATE18', 'ISpeechGrammarRuleState', 'IEnumString',
    'SpeechDiscardType', 'SAFT44kHz16BitStereo', 'eLEXTYPE_RESERVED7',
    'ISpPhrase', 'DISPID_SPPName', 'DISPID_SpeechPhraseProperty',
    'SRADefaultToActive', 'SPBO_PAUSE', 'DISPID_SPIEnginePrivateData',
    'Speech_StreamPos_RealTime', 'SPFM_NUM_MODES',
    'DISPID_SRCEStartStream', 'SpPhoneConverter',
    'SpeechStreamFileMode', 'SPSInterjection', 'SPCS_ENABLED',
    'DISPID_SRRecognizer', 'SECFIgnoreCase',
    'DISPID_SpeechAudioFormat', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SGRSTsCount', 'IEnumSpObjectTokens',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPRNumberOfElements',
    ...
    'DISPID_SOTCGetDataKey', 'SSFMCreate', 'SAFT12kHz8BitMono',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCRecognizer',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechLexicon',
    'SP_VISEME_14', 'SP_VISEME_13', 'DISPID_SRGCmdSetRuleIdState',
    'SGRSTTEpsilon', 'SGRSTTDictation', 'DISPID_SPRuleParent',
    'DISPID_SOTsItem', 'SPEI_RECO_OTHER_CONTEXT', 'ISpeechVoice',
    'SREFalseRecognition', 'SPBINARYGRAMMAR', 'DISPID_SGRSRule',
    'SpStream', 'DISPID_SRGDictationLoad', 'eLEXTYPE_PRIVATE7',
    'SVEPhoneme', 'ISpeechAudio', 'SECNormalConfidence',
    'DISPID_SPPsItem', 'DISPID_SOTCSetId', 'DISPID_SDKEnumKeys',
    'eLEXTYPE_RESERVED6', 'DISPID_SPEEngineConfidence', 'SPSModifier',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGCmdLoadFromObject',
    'SAFT11kHz8BitStereo', 'DISPID_SPPsCount',
    'DISPID_SRSClsidEngine', 'DISPID_SRCSetAdaptationData',
    'ISpVoice', 'DISPID_SWFEExtraData', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_PRIVATE12', 'SAFT8kHz16BitMono',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechRecognizer',
    'SPINTERFERENCE', 'DISPID_SpeechMemoryStream', 'SPSHT_Unknown',
    'SSFMCreateForWrite', 'DISPID_SABIBufferSize',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCRequestedUIType',
    'SPEI_PHRASE_START', 'SpObjectToken', 'SVP_7', 'SPAR_Medium',
    'SpStreamFormatConverter', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechPhraseInfo', 'SpInprocRecognizer', 'SRAInterpreter',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPRuleFirstElement',
    'SVP_20', 'SRSActive', 'SDA_No_Trailing_Space',
    'STSF_LocalAppData', 'SPSFunction', 'SVP_2',
    'DISPID_SGRSTNextState', 'SSSPTRelativeToStart', 'SFTSREngine',
    'SVSFParseSsml', 'SpCustomStream', 'SPCATEGORYTYPE',
    'DISPID_SPEAudioTimeOffset', 'SPRULESTATE', 'DISPID_SVResume',
    'SPPS_RESERVED4', 'SPEI_SR_PRIVATE', 'ISpRecoContext',
    'ISpRecognizer2', 'SPEI_RESERVED1', 'SpeechUserTraining',
    'SITooLoud', 'SpeechDisplayAttributes', 'DISPID_SDKEnumValues',
    'DISPID_SOTCategory'
]
