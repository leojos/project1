...
__all__ = [
    'SPEI_MIN_SR', 'SPSHORTCUTTYPE', 'DISPID_SOTsItem',
    'DISPID_SpeechVoice', 'SP_VISEME_0', 'SpeechLexiconType',
    'SVP_10', 'SAFTGSM610_8kHzMono', 'SSFMCreateForWrite',
    ...
    'ISpeechGrammarRuleStateTransition', 'ISpRecoContext2',
    'DISPID_SRCEPropertyStringChange', 'SpeechRecoProfileProperties',
    'ISpNotifyTranslator', 'DISPID_SGRSTPropertyName',
    'eLEXTYPE_PRIVATE6', 'Speech_Max_Word_Length',
    'SAFTCCITT_uLaw_8kHzMono', 'SVPNormal', 'DISPID_SDKGetlongValue',
    'SECFEmulateResult', 'DISPID_SpeechGrammarRule', 'STCAll',
    'SPSLMA', 'DISPID_SRGCommit', 'ISpeechPhraseProperty',
    'DISPID_SRStatus', 'DISPID_SPELexicalForm', 'DISPID_SABufferInfo',
    'DISPID_SPAs_NewEnum', 'DISPID_SPIEnginePrivateData',
    'SREPrivate', 'SPPHRASERULE', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SLWWord', 'SAFT16kHz16BitStereo', 'SPBO_PAUSE',
    'SPCATEGORYTYPE', 'ISpeechVoiceStatus', 'SDTDisplayText',
    'SpeechRecognizerState', 'SAFT11kHz8BitMono',
    'SpInprocRecognizer', 'DISPID_SRCEStartStream',
    'DISPID_SRRSaveToMemory', 'SGPronounciation',
    'SSSPTRelativeToEnd', 'SP_VISEME_7', 'eLEXTYPE_RESERVED4',
    'SpeechCategoryAudioOut', 'DISPID_SWFEBlockAlign',
    'SPPS_RESERVED2', 'DISPID_SRCEBookmark', 'eLEXTYPE_RESERVED9',
    'DISPID_SRCBookmark', 'DISPID_SLPType', 'SVSFNLPSpeakPunc',
    'SVEAudioLevel', 'SPEI_VISEME', 'SPSMF_UPS', 'DISPID_SPIEngineId',
    'SDTReplacement', 'DISPID_SRCEHypothesis', 'SpeechMicTraining',
    'SBOPause', 'SpeechRuleState', 'DISPID_SPEEngineConfidence',
    'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_17', 'DISPID_SASetState',
    'SPCT_COMMAND', 'DISPID_SRGDictationSetState',
    'ISpeechLexiconPronunciation', 'DISPID_SRGetRecognizers',
    'SpeechCategoryRecoProfiles', 'DISPID_SPRsCount',
    'SAFT48kHz8BitMono', 'SPDKL_LocalMachine', 'SPSNoun', 'SITooLoud',
    'DISPID_SADefaultFormat', 'SpShortcut', 'SASClosed',
    'SpeechAudioFormatType', 'SpeechInterference',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRCRecognizer', 'SVSFParseSapi',
    'DISPID_SBSFormat', 'DISPID_SBSRead',
    'DISPID_SPRuleEngineConfidence', 'SRAExport', 'DISPID_SVStatus',
    'DISPIDSPTSI', 'DISPID_SPCPhoneToId', 'ISpeechBaseStream',
    'DISPID_SpeechPhraseElement', 'ISpStreamFormatConverter',
    'SVEAllEvents', 'ISpEventSource', 'SpeechLoadOption',
    'SRAORetainAudio', 'SPLO_STATIC', 'SVSFNLPMask',
    'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT8kHz8BitMono', 'SECNormalConfidence', 'SREStreamEnd',
    'DISPID_SRGetPropertyString', 'SP_VISEME_3',
    'DISPID_SOTRemoveStorageFileName', 'SRTStandard',
    'SAFT32kHz8BitMono', 'eLEXTYPE_LETTERTOSOUND', 'SVSFIsFilename',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_21',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGetFormat',
    ...
    'SDKLDefaultLocation', 'SPPS_Modifier', 'eLEXTYPE_PRIVATE9',
    'SPVPRI_ALERT', 'SVSFUnusedFlags', 'SAFT24kHz16BitStereo',
    'SDA_No_Trailing_Space', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCEPhraseStart',
    'DISPID_SOTCreateInstance', 'DISPID_SGRInitialState',
    'ISpeechLexiconWord', 'DISPID_SVSVisemeId',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRCState',
    'DISPID_SVSLastResult', 'SPINTERFERENCE_NONE', 'SP_VISEME_13',
    'DISPID_SRCRequestedUIType', 'SVSFIsXML', 'DISPID_SPIProperties',
    'DISPID_SRGRecoContext', 'DISPID_SRDisplayUI',
    'DISPID_SpeechGrammarRules', 'SP_VISEME_5',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPCT_SLEEP',
    'ISpeechPhraseReplacement', 'DISPID_SRRDiscardResultInfo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpStream',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRAddState',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVAudioOutputStream',
    'ISpDataKey', 'ISpeechRecognizer', 'DISPID_SpeechPhraseBuilder',
    'SPLEXICONTYPE', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFTADPCM_22kHzStereo', 'SVP_16', 'SVP_9',
    'DISPID_SpeechRecognizerStatus', 'SPAO_RETAIN_AUDIO',
    'SPEI_RECOGNITION', 'DISPID_SVVolume', 'DISPID_SLWsItem',
    'ISequentialStream', 'ISpRecoGrammar2', 'DISPID_SRCRetainedAudio',
    'SpeechBookmarkOptions', 'SpeechDataKeyLocation',
    'SpeechVoicePriority', 'SRCS_Enabled', 'SVSFParseSsml',
    'DISPID_SRRTTickCount', 'SPVISEMES', 'DISPID_SRCVoice',
    'DISPID_SMSALineId', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPIGetDisplayAttributes', 'Speech_Default_Weight',
    'SITooFast', 'SREPropertyStringChange',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPEAudioStreamOffset',
    'SPRST_INACTIVE', 'SpeechDictationTopicSpelling',
    'DISPID_SLWsCount', 'SpeechCategoryAppLexicons',
    'DISPID_SLAddPronunciationByPhoneIds', 'SRTExtendableParse',
    'ISpeechLexiconWords', 'SP_VISEME_10', 'SPEI_RESERVED1',
    'SpeechCategoryRecognizers', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVP_2', 'ISpProperties',
    'SVPAlert', 'SGSDisabled', 'SpMMAudioIn', 'DISPID_SVEStreamEnd',
    'SpeechAudioProperties', 'SPCT_DICTATION', 'SREStateChange',
    'SPEI_VOICE_CHANGE', 'SWPUnknownWordUnpronounceable',
    'SPAS_CLOSED', 'SpeechEngineProperties',
    'DISPID_SGRSAddWordTransition', 'SP_VISEME_4',
    'eLEXTYPE_PRIVATE19', 'DISPID_SVSyncronousSpeakTimeout',
    'IEnumString', 'ISpAudio', 'DISPID_SLAddPronunciation',
    'SDTLexicalForm', 'SDTPronunciation', 'eLEXTYPE_PRIVATE10',
    'ISpeechMMSysAudio', 'SGRSTTDictation', 'SPRST_ACTIVE_ALWAYS',
    'SPEVENT', 'ISpeechPhraseAlternates', 'DISPID_SOTIsUISupported',
    'DISPID_SDKCreateKey', 'DISPID_SRIsShared', 'SRARoot',
    'DISPID_SPPNumberOfElements', 'eLEXTYPE_PRIVATE14',
    'SPGS_EXCLUSIVE', 'Speech_StreamPos_RealTime',
    'SAFTADPCM_11kHzMono', 'DISPID_SVEEnginePrivate', 'SP_VISEME_11',
    'SVEVoiceChange', 'DISPID_SRGDictationUnload', 'SpMemoryStream',
    'DISPID_SAFGuid', 'SAFT48kHz16BitMono', 'SpeechEngineConfidence',
    'ISpeechFileStream', 'ISpeechRecognizerStatus',
    'DISPID_SPPs_NewEnum', 'DISPID_SMSGetData', 'SPPROPERTYINFO',
    'DISPID_SLPPartOfSpeech', 'SAFT48kHz16BitStereo',
    'SpeechCategoryPhoneConverters', 'DISPID_SPPsItem',
    'SpCompressedLexicon', 'SAFT8kHz8BitStereo', 'DISPID_SPPChildren',
    'IInternetSecurityManager', 'SVF_None', 'DISPID_SOTCId',
    'DISPID_SGRSTText', 'DISPID_SRCESoundStart', 'SAFT24kHz8BitMono',
    'SINone', 'SPTEXTSELECTIONINFO', 'SPEI_RESERVED5',
    'SPEI_END_SR_STREAM', 'SPAR_Unknown', 'SPEI_END_INPUT_STREAM',
    'SAFT44kHz16BitMono', 'SPDKL_CurrentUser', 'DISPID_SDKEnumKeys',
    'DISPID_SABufferNotifySize', 'SDTAlternates',
    'ISpObjectTokenCategory', 'DISPID_SGRSTNextState',
    'SAFT8kHz16BitStereo', 'eLEXTYPE_PRIVATE3', 'SPAUDIOOPTIONS',
    'SPSHT_OTHER', 'SPWT_DISPLAY', 'DISPID_SOTCEnumerateTokens',
    'SPINTERFERENCE_NOSIGNAL',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechAudioStatus',
    'DISPID_SLWPronunciations', 'DISPID_SVEPhoneme', 'SPGS_ENABLED',
    ...
    'ISpeechXMLRecoResult', 'SAFT16kHz8BitMono', 'SGRSTTRule',
    'DISPID_SVSpeak', 'eLEXTYPE_PRIVATE17', 'SPPS_RESERVED1',
    'SPXRO_Alternates_SML', 'SGRSTTEpsilon', 'ISpeechObjectToken',
    'SPPHRASE', 'ISpObjectWithToken', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechLexicon', 'SpeechPropertyComplexResponseSpeed',
    'SPBOOKMARKOPTIONS', 'SREHypothesis', 'SPPS_Verb',
    'DISPID_SRRTimes', 'DISPID_SpeechObjectTokens',
    'DISPID_SGRSTPropertyId', 'SAFT12kHz8BitStereo', 'SRAONone',
    'SSFMOpenForRead', 'ISpXMLRecoResult', 'SPPARTOFSPEECH',
    'SpPhraseInfoBuilder', 'SpeechGrammarState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRText', 'SPEI_UNDEFINED', 'SPVPRI_OVER',
    'DISPID_SGRsItem', 'SWPKnownWordPronounceable',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPARecoResult',
    'DISPID_SPEs_NewEnum', 'SPVOICESTATUS',
    'SpeechSpecialTransitionType', 'SVSFIsNotXML',
    'SpeechPropertyResourceUsage', 'SECHighConfidence', 'SLODynamic',
    'SPEI_PHRASE_START', 'DISPID_SGRSRule', '_ISpeechVoiceEvents',
    'DISPID_SRRPhraseInfo', 'SpInProcRecoContext',
    'SpeechRecognitionType', 'DISPID_SPISaveToMemory',
    'SpeechTokenKeyFiles', 'SPSHT_Unknown', 'SAFT16kHz16BitMono',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_PRIVATE11',
    'SVEEndInputStream', 'SPEI_RESERVED2', 'DISPID_SRCESoundEnd',
    'SPWORDTYPE', 'SP_VISEME_8', 'SpeechPropertyAdaptationOn',
    'DISPID_SOTDataKey', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SDKEnumValues', 'SPSFunction', 'SPRULESTATE',
    'SPDATAKEYLOCATION', 'SPSEMANTICFORMAT', 'SPRULE', 'SVEPrivate',
    'SVSFlagsAsync', 'DISPID_SPIAudioSizeBytes',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_MORPHOLOGY', 'SPXRO_SML',
    'SPDKL_CurrentConfig', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPILanguageId', 'SPSHT_NotOverriden', 'SpeechRecoEvents',
    'DISPID_SWFEFormatTag', 'SRESoundEnd', 'ISpGrammarBuilder',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGRules',
    'eLEXTYPE_PRIVATE12', 'IStream', 'SPEI_SOUND_START',
    'DISPID_SPIReplacements', 'ISpRecognizer3', 'SSFMOpenReadWrite',
    'DISPID_SRIsUISupported', 'SVP_18',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpResourceManager',
    'DISPID_SPRuleChildren', 'DISPID_SLPsItem', 'SVEStartInputStream',
    'DISPID_SRSetPropertyNumber', 'SITooQuiet', 'SDTAudio',
    'DISPID_SRRTLength', 'DISPID_SLPs_NewEnum', 'SAFT16kHz8BitStereo',
    'SpeechTokenShellFolder', 'SPRST_NUM_STATES',
    'SPINTERFERENCE_TOOSLOW', 'SPFM_NUM_MODES',
    'DISPID_SAEventHandle', 'DISPID_SFSClose', 'SAFT22kHz8BitMono',
    'SpCustomStream', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpSharedRecognizer', 'SRESoundStart', 'SPINTERFERENCE',
    'ISpNotifySink', 'SPPS_NotOverriden', 'ISpeechAudioBufferInfo',
    'SPLO_DYNAMIC', 'SPRECOSTATE', 'ISpeechRecoResult2',
    'DISPID_SGRAddResource', 'DISPID_SRAudioInput',
    'SpeechAudioFormatGUIDWave', 'DISPID_SGRSTsItem',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCEFalseRecognition',
    'SPSTREAMFORMATTYPE', 'SVP_13', 'DISPID_SRRAudio',
    'DISPID_SAVolume', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpAudioFormat', 'DISPID_SRRecognizer', 'ISpRecoGrammar',
    'DISPID_SGRId', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechGrammarWordType', 'DISPID_SDKSetStringValue',
    'SPCT_SUB_DICTATION', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SOTGetStorageFileName',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_PHONEME',
    'ISpeechAudioFormat', 'SREInterference', 'DISPID_SRRAudioFormat',
    'SP_VISEME_20', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechPhraseElements', 'SpLexicon', 'SPEI_WORD_BOUNDARY',
    'SPPS_Unknown', 'DISPID_SLPLangId', 'DISPID_SPIGrammarId',
    'SPEVENTSOURCEINFO', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_INTERFERENCE', 'SPSUnknown', 'SPEVENTENUM',
    'SRSEIsSpeaking', 'SPRECOGNIZERSTATUS', 'SECFDefault',
    'SpTextSelectionInformation', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTCDefault', 'DISPID_SLWs_NewEnum', 'DISPID_SLPPhoneIds',
    'SAFTExtendedAudioFormat', 'SPBO_NONE', 'SPCS_DISABLED',
    'SAFT44kHz16BitStereo', 'SPSHORTCUTPAIR', 'ISpMMSysAudio',
    'eLEXTYPE_APP', 'ISpeechPhraseReplacements', 'DISPID_SpeechAudio',
    'SPSNotOverriden', 'DISPID_SDKSetLongValue', 'SpObjectToken',
    'DISPID_SRCEAdaptation', 'SAFT32kHz8BitStereo',
    'SGDSActiveUserDelimited', 'DISPID_SRCCreateGrammar',
    'SDA_One_Trailing_Space', 'DISPID_SVEVoiceChange',
    'SpeechAudioFormatGUIDText', 'SPAO_NONE', 'SFTSREngine',
    'SDTProperty', 'ISpeechAudio', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRRAlternates', 'SAFTADPCM_22kHzMono',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRName',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRState', 'SWTAdded',
    'DISPID_SpeechXMLRecoResult', 'SGDisplay', 'SVSFVoiceMask',
    'SAFTCCITT_uLaw_8kHzStereo', 'SSTTWildcard',
    'ISpeechObjectTokenCategory', 'SPAS_STOP', 'DISPID_SOTCategory',
    'SVP_3', 'DISPID_SpeechPhraseRule', 'ISpeechRecoResult',
    'DISPIDSPTSI_SelectionLength', 'SAFT12kHz16BitMono',
    'ISpeechPhraseElements', 'SREAudioLevel', 'SpeechTokenContext',
    'SASRun', 'SPFM_CREATE_ALWAYS', 'SPPHRASEELEMENT',
    'DISPID_SPIGetText', 'ISpeechPhraseElement',
    'SAFTCCITT_uLaw_44kHzMono', 'SVP_11', 'SVP_4',
    'SAFTADPCM_44kHzStereo', '__MIDL_IWinTypes_0009',
    'DISPID_SABIBufferSize', 'DISPID_SVEStreamStart', 'DISPID_SVSkip',
    'SPWORD', 'SAFT22kHz16BitStereo', 'SPAS_PAUSE',
    'DISPID_SRGetPropertyNumber', 'DISPID_SOTCGetDataKey',
    'DISPID_SOTGetAttribute', 'ISpeechMemoryStream',
    'SpeechUserTraining', 'DISPID_SVVoice', 'SPEI_TTS_AUDIO_LEVEL',
    'SVP_17', 'DISPID_SpeechPhraseInfo', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPEActualConfidence', 'SRADynamic', 'SVEViseme',
    'SPAUDIOBUFFERINFO', 'DISPID_SLGetWords',
    'DISPID_SVSLastBookmarkId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT32kHz16BitStereo',
    ...
    'SGDSInactive', 'SpUnCompressedLexicon', 'SPEI_RESERVED6',
    'DISPID_SRCEAudioLevel', 'eLEXTYPE_RESERVED10',
    ...
    'DISPID_SLPSymbolic', 'SP_VISEME_19', 'ISpeechPhraseAlternate',
    'SpeechVoiceSpeakFlags', 'UINT_PTR', 'SVEPhoneme',
    'ISpeechRecoResultTimes', 'DISPID_SpeechDataKey',
    'DISPID_SMSSetData', 'DISPID_SpeechRecoResult2',
    'DISPID_SPAsCount', 'SAFT24kHz16BitMono', 'ISpRecoCategory',
    'DISPID_SPEDisplayAttributes', 'ISpeechRecoContext',
    'ISpSerializeState', 'SRSActive', 'SDA_Consume_Leading_Spaces',
    ...
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SDKGetBinaryValue',
    'SPINTERFERENCE_NOISE', 'SGLexicalNoSpecialChars', 'SLTApp',
    'SPPS_Interjection', 'eLEXTYPE_RESERVED6', 'DISPID_SVSpeakStream',
    'SpeechRecoContextState', 'DISPID_SDKGetStringValue',
    'ISpeechWaveFormatEx', 'ISpeechLexiconPronunciations',
    'DISPID_SRCEPropertyNumberChange', 'ISpLexicon',
    'SpeechGrammarTagDictation', 'SPPHRASEPROPERTY',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRSEDone', 'DISPID_SVResume',
    'SpeechRetainedAudioOptions', 'SGRSTTWildcard',
    '_RemotableHandle', 'DISPID_SpeechMemoryStream',
    'IEnumSpObjectTokens', 'SpWaveFormatEx', 'SpeechDiscardType',
    'SPGS_DISABLED', 'SWTDeleted', 'DISPID_SRGCmdLoadFromMemory',
    'SASPause', 'ISpStreamFormat', 'SAFTNoAssignedFormat',
    'SRTEmulated', 'SAFT48kHz8BitStereo', 'SVP_15', 'DISPID_SPEsItem',
    'DISPID_SLGenerationId', 'SVSFParseAutodetect',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SWFEExtraData', 'SVP_20',
    'DISPIDSPRG', 'SpeechVoiceCategoryTTSRate',
    'SpObjectTokenCategory', 'SpeechRuleAttributes',
    'SPWORDPRONUNCIATION', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechTokenIdUserLexicon', 'SAFTText', 'DISPID_SGRAttributes',
    'SAFTCCITT_uLaw_22kHzMono', 'STSF_CommonAppData',
    'DISPID_SPIStartTime', 'DISPID_SpeechRecognizer', 'SVEBookmark',
    'SPVPRIORITY', 'DISPID_SPRs_NewEnum', 'SP_VISEME_21',
    'DISPID_SLRemovePronunciation', 'SPEI_HYPOTHESIS',
    'DISPID_SVSInputWordLength', '_SPAUDIOSTATE', 'SGSExclusive',
    'ISpeechCustomStream', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRGId', 'SPVPRI_NORMAL', 'SLTUser', 'SGDSActive',
    'SPSHT_EMAIL', 'DISPID_SRGState',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SGRClear', 'SRAImport',
    'ISpPhrase', 'SRCS_Disabled', 'LONG_PTR', 'ISpRecoResult',
    'DISPID_SPAsItem', 'STSF_AppData', 'SPEI_START_SR_STREAM',
    'ISpeechLexicon', 'eLEXTYPE_PRIVATE13', 'SAFTADPCM_8kHzStereo',
    'SpeechCategoryVoices', 'DISPID_SRCERequestUI',
    'eLEXTYPE_RESERVED7', 'SAFT11kHz16BitMono', 'DISPID_SVPriority',
    'SREAdaptation', 'DISPID_SRAudioInputStream',
    'SPWT_PRONUNCIATION', 'SAFTCCITT_ALaw_8kHzStereo',
    'STCInprocHandler', 'SPEI_SR_PRIVATE', 'DISPID_SOTDisplayUI',
    'SPPS_SuppressWord', 'SVSFDefault', 'SpeechTokenKeyAttributes',
    ...
    'SpeechPartOfSpeech', 'SpeechGrammarTagUnlimitedDictation',
    'SSSPTRelativeToStart', 'DISPID_SVSInputWordPosition',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_PRIVATE18',
    'SPWAVEFORMATTYPE', 'SRTAutopause', 'DISPID_SVGetVoices',
    'DISPID_SRRGetXMLResult', 'DISPID_SRSetPropertyString',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SOTs_NewEnum',
    'SpeechPropertyNormalConfidenceThreshold', 'WAVEFORMATEX',
    'SPDKL_DefaultLocation', 'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE4',
    'SPFILEMODE', 'SpeechPropertyHighConfidenceThreshold',
    'SVF_Emphasis', 'SpeechRunState', 'SAFTTrueSpeech_8kHz1BitMono',
    'SREAllEvents', 'DISPID_SPEAudioTimeOffset', 'SASStop',
    'SREPhraseStart', 'SpSharedRecoContext', 'SP_VISEME_18',
    'DISPID_SVPause', 'ISpeechPhraseInfoBuilder', 'DISPID_SGRsCommit',
    'SP_VISEME_16', 'DISPID_SPRuleId', 'DISPID_SOTRemove', 'SPPS_LMA',
    'SP_VISEME_15', 'SDKLCurrentConfig', 'DISPID_SOTsCount',
    'DISPID_SpeechPhraseReplacement', 'DISPIDSPTSI_ActiveOffset',
    'SAFT12kHz8BitMono', 'DISPID_SMSAMMHandle', 'DISPID_SGRsAdd',
    'tagSPPROPERTYINFO', 'SVP_7', 'SPWORDPRONOUNCEABLE', 'SGRSTTWord',
    'DISPID_SVDisplayUI', 'SPEI_MIN_TTS', 'DISPID_SpeechPhraseRules',
    'SP_VISEME_1', 'DISPID_SRCVoicePurgeEvent', 'SPAR_High',
    'SPWF_INPUT', 'SAFTDefault', 'DISPID_SPEPronunciation',
    'DISPID_SGRsCommitAndSave', 'SRERequestUI', 'SRERecognition',
    'SpMMAudioOut', 'SSFMCreate', 'SPFM_OPEN_READONLY',
    'SpeechCategoryAudioIn', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SASState', 'DISPID_SDKDeleteValue', 'SP_VISEME_12',
    'eLEXTYPE_PRIVATE15', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRCResume', 'SPBO_TIME_UNITS', 'DISPID_SVSRunningState',
    'SRSActiveAlways', 'SpNullPhoneConverter', 'ISpNotifySource',
    'Speech_StreamPos_Asap', 'SpeechVoiceEvents', 'DISPID_SRGReset',
    'DISPID_SRProfile', 'DISPID_SpeechRecoContextEvents',
    'ISpeechPhraseProperties', 'DISPID_SRRGetXMLErrorInfo',
    'SPSInterjection', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPEngineConfidence',
    'ISpObjectToken', 'SPCT_SUB_COMMAND', 'SPPHRASEREPLACEMENT',
    'DISPID_SRGDictationLoad', 'SVSFPersistXML',
    'DISPID_SVSpeakCompleteEvent', 'SREBookmark',
    'SAFTCCITT_uLaw_44kHzStereo', 'SRERecoOtherContext',
    'eLEXTYPE_USER', 'tagSPTEXTSELECTIONINFO',
    'SpeechTokenValueCLSID', 'DISPID_SLWLangId',
    'SAFT44kHz8BitStereo', 'SpeechEmulationCompareFlags',
    'SAFT22kHz16BitMono', 'DISPID_SRCCreateResultFromMemory',
    'SPSSuppressWord', 'DISPID_SpeechLexiconWords', 'SPEI_ADAPTATION',
    ...
    'DISPID_SPEDisplayText', 'DISPID_SLWType', 'SPEI_RESERVED3',
    'SDKLLocalMachine', 'DISPID_SVGetAudioOutputs',
    ...
    'SRSInactiveWithPurge', 'DISPID_SDKOpenKey',
    'SGDSActiveWithAutoPause', 'SP_VISEME_14', 'SPPS_RESERVED4',
    'DISPID_SOTCSetId', 'SVSFParseMask', 'DISPID_SPCIdToPhone',
    'SRSInactive', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPRFirstElement', 'DISPID_SpeechLexiconProns',
    'SLOStatic', 'DISPID_SRCPause', 'SRAInterpreter',
    'SpeechRegistryUserRoot', 'DISPID_SPIElements', 'SPPS_Function',
    'SINoSignal', 'DISPID_SCSBaseStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpResourceManager',
    'ISpeechGrammarRules', 'DISPID_SPPId', 'SPRS_INACTIVE',
    'SPAR_Low', 'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpShortcut', 'DISPID_SRCreateRecoContext',
    'ISpeechPhoneConverter', 'DISPID_SpeechPhoneConverter',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRCCmdMaxAlternates', 'eLEXTYPE_PRIVATE7', 'SPAR_Medium',
    'DISPID_SVRate', 'SBONone', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SGRSAddRuleTransition', 'ISpeechVoice', 'SpMMAudioEnum',
    'eWORDTYPE_ADDED', 'SECFIgnoreCase', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPPValue', 'DISPID_SGRSTRule', 'SPPS_RESERVED3',
    'SpeechStreamSeekPositionType', 'STCLocalServer',
    'SPEI_START_INPUT_STREAM', 'SAFT24kHz8BitStereo',
    'DISPID_SVIsUISupported', 'SpeechVisemeType',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SREmulateRecognition',
    'DISPID_SPRsItem', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPRuleParent', 'eLEXTYPE_PRIVATE1', 'SRTSMLTimeout',
    'DISPID_SPIRetainedSizeBytes', 'SPWF_SRENGINE', 'SVP_14',
    'DISPID_SBSWrite', 'DISPID_SMSADeviceId', 'DISPID_SGRs_NewEnum',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SASNonBlockingIO',
    'DISPIDSPTSI_ActiveLength', 'ISpeechTextSelectionInformation',
    'SDTAll', 'SP_VISEME_2', 'SPEI_MAX_SR', 'SPAUDIOSTATUS',
    'SpeechAddRemoveWord', 'SVP_1', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCEInterference', 'DISPID_SDKDeleteKey', 'SP_VISEME_9',
    'SAFTNonStandardFormat', 'SGSEnabled', 'SpeechGrammarTagWildcard',
    'SGLexical', 'DISPID_SPPFirstElement', 'DISPID_SPRules_NewEnum',
    'ISpRecognizer', 'ISpeechGrammarRuleStateTransitions',
    'SPBO_AHEAD', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SGRSTPropertyValue', 'SPSERIALIZEDPHRASE',
    'ISpRecognizer2', 'SpeechTokenKeyUI', 'DISPID_SPRuleName',
    'DISPID_SVSLastBookmark', 'ISpRecoContext', 'SVP_0', 'ISpStream',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVEAudioLevel',
    'SWPUnknownWordPronounceable', 'SITooSlow', 'SPCS_ENABLED',
    'DISPID_SPRuleConfidence', 'ISpPhoneConverter', 'SDTRule',
    'SPEI_SR_BOOKMARK', 'SPRST_INACTIVE_WITH_PURGE',
    'SPSEMANTICERRORINFO', 'ISpeechPhraseRules',
    'DISPID_SVGetAudioInputs', 'ISpPhraseAlt', 'SFTInput',
    'SAFTCCITT_ALaw_22kHzMono', 'IInternetSecurityMgrSite',
    'SpeechAudioVolume', 'DISPID_SAFType', 'DISPID_SABIEventBias',
    'SPFM_CREATE', 'SRADefaultToActive', 'SPSERIALIZEDRESULT',
    ...
    'DISPID_SRCERecognition', 'SAFTADPCM_11kHzStereo', 'SVPOver',
    'DISPID_SOTGetDescription', 'DISPID_SPRulesItem',
    'SPCONTEXTSTATE', 'DISPID_SpeechPhraseProperties',
    'SECFIgnoreWidth', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRsFindRule', 'DISPID_SGRSTs_NewEnum',
    'SAFTCCITT_ALaw_44kHzMono', 'eWORDTYPE_DELETED', 'SVP_19',
    'SPSMF_SAPI_PROPERTIES', 'SECLowConfidence', 'STSF_LocalAppData',
    'DISPID_SGRsDynamic', 'SVP_8', 'SpeechAllElements',
    'DISPID_SRCSetAdaptationData', 'DISPID_SLGetPronunciations',
    'STCInprocServer', 'DISPID_SOTMatchesAttributes',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRSTransitions',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPIAudioSizeTime', 'SpeechWordPronounceable',
    'SSTTDictation', 'SGRSTTTextBuffer', 'SVP_6',
    'ISpeechRecoResultDispatch', 'SpeechFormatType',
    'SPBINARYGRAMMAR', 'SPSModifier', 'SpPhoneConverter', 'SVP_12',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechFileStream',
    'SREFalseRecognition', 'eLEXTYPE_PRIVATE16',
    'DISPID_SASCurrentDevicePosition', 'SpFileStream',
    ...
    'DISPID_SVEViseme', 'DISPID_SFSOpen', 'SSTTTextBuffer',
    'STSF_FlagCreate', 'SAFT32kHz16BitMono', 'SpeechWordType',
    'ISpPhoneticAlphabetSelection', 'SVF_Stressed',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SWFEBitsPerSample',
    'SAFT22kHz8BitStereo', 'DISPID_SPPConfidence',
    'DISPID_SVAudioOutput', 'SP_VISEME_6', 'SAFTGSM610_44kHzMono',
    'Speech_Max_Pron_Length', 'SPAS_RUN', 'DISPID_SVAlertBoundary',
    'SPRECORESULTTIMES', 'SPRS_ACTIVE', 'tagSTATSTG',
    'SPSHORTCUTPAIRLIST', 'SPXMLRESULTOPTIONS',
    'DISPID_SRCEEndStream', 'SAFT44kHz8BitMono',
    'SpeechVisemeFeature', 'SVP_5', 'DISPID_SPPsCount', 'SPSVerb',
    'DISPID_SPCLangId', 'DISPID_SRRSpeakAudio',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPERequiredConfidence',
    'DISPID_SRRRecoContext', 'SVESentenceBoundary',
    'ISpeechAudioStatus', 'SPRST_ACTIVE', 'SpeechAudioState',
    'SPEI_REQUEST_UI', 'DISPID_SPIRule',
    'DISPID_SVSInputSentencePosition', 'SAFTGSM610_11kHzMono',
    'ISpEventSink', 'SECFIgnoreKanaType', 'ISpeechGrammarRule',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SABIMinNotification',
    'DISPID_SpeechVoiceStatus', 'SREStreamStart', 'SRTReSent',
    'DISPID_SRSClsidEngine', 'DISPID_SPEsCount', 'DISPID_SAStatus',
    'SPWT_LEXICAL', 'SPPS_Noun', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPAPhraseInfo', 'SPWORDLIST', 'DISPID_SpeechBaseStream',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTId', 'DISPID_SGRSTType',
    'DISPID_SpeechVoiceEvent', 'SpeechStreamFileMode',
    'SVEWordBoundary', 'SPLOADOPTIONS', 'SINoise', 'ISpVoice'
]
